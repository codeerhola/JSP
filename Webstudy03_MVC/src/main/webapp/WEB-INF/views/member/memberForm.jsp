...
<body>
	...
	<form method="post">
		<table>
			...
			<tr>
				<th>주민번호2</th>
				<td><input class="from-control" type="text" name="memRegno2"
					value="${member.memRegno2}" /><span class="text-danger">${errors.memRegno2}<span><td>
			</tr>
			<tr>
				<th>생일</th>
				<td><input class="from-control" type="date" 
			...
			<tr>
				<th>마일리지</th>
				<td><input class="from-control" type="number" name="memMileage"
					value="${member.memMileage}" /><span class="text-danger">${errors.memMileage}<span><td>
			</tr>
			<tr>
				<th>탈퇴여부</th>
				<td><input class="from-control" type="text" name="memDelete"
