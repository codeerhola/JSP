...
*/		//1-1.serlialization : 객체의 상태를 전송이나 저장이 가능한 형태로 스트림화.(바이트 배열로 변환)
		//json을 파일로 기록해보자
		...
		BufferedWriter bw = new BufferedWriter(writer);
			...
			mapper.writeValue(bw, target); //메소드 하나 
		}
		...
		//2. json -> native : unmarshalling - readXXX
			...
			Map<String,Object> map = mapper.readValue(br, Map.class); //메소드 하나 
			System.out.println(map);
		}
